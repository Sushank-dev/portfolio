...
const vertexShader = `
  ...
  void main() {
    ...
    noise += snoise(position * 1.6 + uTime * 0.15) * 0.5;
...
const fragmentShader = `
  ...
  void main() {
    ...
    vec3 color = mix(uColor1, uColor2, fresnel + vDisplacement * 0.5);
    float alpha = 0.12 + fresnel * 0.15;
...
function Blob() {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uColor1: { value: new THREE.Color("#d4622b") },
  ...
  useFrame((state) => {
    ...
    const c1 = theme === "dark" ? "#d4622b" : "#c9a96e";
    const c2 = theme === "dark" ? "#c9a96e" : "#d4622b";
    uniforms.uColor1.value.set(c1);
    uniforms.uColor2.value.set(c2);
  });
